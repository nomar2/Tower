...
has been flown against a MINI Pix / ArduCopter 4.7.0 over a 433 MHz radio, Wi-Fi
and a TCP link (MAVLink 1 and 2) — connection, telemetry, mode changes, arm,
takeoff, mission edit/upload/download/run, parameters, reboot and
vehicle-mission-clear all work. Follow-me and the dronie are still
simulator-only.
