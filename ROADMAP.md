...
4.7.0 over a USB-serial 433 MHz SiK radio, Wi-Fi and TCP / UDP links (MAVLink 1
and 2) —
...
Follow-me (every sub-mode) GUIDED go-to and auto missions are validated end-to-end against
SITL through the app (ArduCopter 4.7.1, MAVLink 2), with the phone's real GPS.
Follow-me and the dronie are not yet flown on a real vehicle.

## Priority 1 — make it field-ready and publishable

- [x] **Hardware connectivity** — USB-serial (433 MHz SiK radio over an OTG
      cable), Wi-Fi, TCP and UDP tested on a MINI Pix (ArduCopter 4.7.0),
      MAVLink 1 and 2.
...
- [x] **In-flight validation** — arm / takeoff / mode changes / mission
      ...
      Look-at-Me) **GUIDED go-to** and **auto missions** validated end-to-end against SITL
      through the app (ArduCopter 4.7.1, MAVLink 2). Still to fly on a vehicle:
