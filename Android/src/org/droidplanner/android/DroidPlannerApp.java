...
public class DroidPlannerApp extends MultiDexApplication implements DroneListener, TowerListener, LinkListener {
    ...
    /** Application context, for the handful of static utilities that need one. */
            ...
            case AttributeEvent.STATE_CONNECTED: {
                ...
                try {
                    ContextCompat.startForegroundService(this,
                            new Intent(this, AppService.class));
                } catch (Exception e) {
                    // ForegroundServiceStartNotAllowedException on Android 12+ when
                    // the connection completes with the app in the background. The
                    // dronekit service keeps the process alive; AppService is
                    // (re)bound the next time an activity is shown.
                    Timber.w(e, "Unable to start AppService");
                }
