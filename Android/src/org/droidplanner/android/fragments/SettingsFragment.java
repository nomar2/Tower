    ...
    private void updateFirmwareVersionPreference(Type droneType) {
        ...
        if (firmwareVersionPref != null) {
            if (firmwareVersion == null) {
                ...
                GAUtils.logEvent(GAUtils.Category.MAVLINK_CONNECTION, "Firmware version unset");
            } else {
                firmwareVersionPref.setSummary(firmwareVersion);
                GAUtils.logEvent(GAUtils.Category.MAVLINK_CONNECTION, "Firmware version set", firmwareVersion);
            }
        }
    }
