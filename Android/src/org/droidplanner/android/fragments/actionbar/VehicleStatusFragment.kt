...
public class VehicleStatusFragment : ApiListenerFragment() {
    ...
    private val connectedIcon by lazy(LazyThreadSafetyMode.NONE) {
        view?.findViewById<ImageView>(R.id.status_vehicle_connection)
    }

    private val batteryIcon by lazy(LazyThreadSafetyMode.NONE) {
        view?.findViewById<ImageView>(R.id.status_vehicle_battery)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        titleView = view.findViewById<TextView>(R.id.status_actionbar_title)
