...
public class ModeDisconnectedFragment extends PreferenceFragmentCompat {
    ...
    public void onDisplayPreferenceDialog(Preference preference) {
        if (preference instanceof ClearBTDialogPreference) {
            ...
            if (dialogFragment == null) {
                ...
                dialogFragment.show(getFragmentManager(), "androidx.preference.PreferenceFragmentCompat.DIALOG");
            }
        } else {
    ...
    private DialogFragment getDialogFragment(){
        return (DialogFragment) getFragmentManager().findFragmentByTag("androidx.preference.PreferenceFragmentCompat.DIALOG");
    }
