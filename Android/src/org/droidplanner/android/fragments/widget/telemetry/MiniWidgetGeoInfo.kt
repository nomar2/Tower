...
class MiniWidgetGeoInfo : TowerWidget() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        latitude = view.findViewById<TextView>(R.id.latitude_telem)
        longitude = view.findViewById<TextView>(R.id.longitude_telem)

        val clipboardMgr = requireContext().getSystemService(Context.CLIPBOARD_SERVICE) as ClipboardManager
