...
public class MiniWidgetAttitudeSpeedInfo : TowerWidget() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        attitudeIndicator = view.findViewById<AttitudeIndicator>(R.id.aiView)

        roll = view.findViewById<TextView>(R.id.rollValueText)
        yaw = view.findViewById<TextView>(R.id.yawValueText)
        pitch = view.findViewById<TextView>(R.id.pitchValueText)

        horizontalSpeed = view.findViewById<TextView>(R.id.horizontal_speed_telem)
        verticalSpeed = view.findViewById<TextView>(R.id.vertical_speed_telem)
    }
