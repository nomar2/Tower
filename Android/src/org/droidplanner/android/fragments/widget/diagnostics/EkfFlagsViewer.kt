...
public class EkfFlagsViewer : BaseWidgetDiagnostic() {
    ...
    private fun setupEkfFlags(view: View){
        ekfFlagsViews.put(EkfStatus.EkfFlags.EKF_ATTITUDE, view.findViewById<TextView>(R.id.ekf_attitude_flag))
        ekfFlagsViews.put(EkfStatus.EkfFlags.EKF_CONST_POS_MODE, view.findViewById<TextView>(R.id.ekf_const_pos_flag))
        ekfFlagsViews.put(EkfStatus.EkfFlags.EKF_VELOCITY_VERT, view.findViewById<TextView>(R.id.ekf_velocity_vert_flag))
        ekfFlagsViews.put(EkfStatus.EkfFlags.EKF_VELOCITY_HORIZ, view.findViewById<TextView>(R.id.ekf_velocity_horiz_flag))
        ekfFlagsViews.put(EkfStatus.EkfFlags.EKF_POS_HORIZ_REL, view.findViewById<TextView>(R.id.ekf_position_horiz_rel_flag))
        ekfFlagsViews.put(EkfStatus.EkfFlags.EKF_POS_HORIZ_ABS, view.findViewById<TextView>(R.id.ekf_position_horiz_abs_flag))
        ekfFlagsViews.put(EkfStatus.EkfFlags.EKF_PRED_POS_HORIZ_ABS, view.findViewById<TextView>(R.id.ekf_position_horiz_pred_abs_flag))
        ekfFlagsViews.put(EkfStatus.EkfFlags.EKF_PRED_POS_HORIZ_REL, view.findViewById<TextView>(R.id.ekf_position_horiz_pred_rel_flag))
        ekfFlagsViews.put(EkfStatus.EkfFlags.EKF_POS_VERT_AGL, view.findViewById<TextView>(R.id.ekf_position_vert_agl_flag))
        ekfFlagsViews.put(EkfStatus.EkfFlags.EKF_POS_VERT_ABS, view.findViewById<TextView>(R.id.ekf_position_vert_abs_flag))
    }
}