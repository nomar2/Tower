...
public class VibrationViewer : GraphDiagnosticViewer() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        clippingViews.set(0, view.findViewById<TextView>(R.id.primary_clipping_value))
        clippingViews.set(1, view.findViewById<TextView>(R.id.secondary_clipping_value))
        clippingViews.set(2, view.findViewById<TextView>(R.id.tertiary_clipping_value))
    }
