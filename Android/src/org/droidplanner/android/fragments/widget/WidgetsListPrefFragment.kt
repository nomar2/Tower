...
class WidgetsListPrefFragment : DialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val widgetsListPref = view.findViewById<ListView>(R.id.widgets_list_pref)
    ...
    class WidgetsAdapter(context: Context, val fm : FragmentManager) : ArrayAdapter<TowerWidgets>(context, 0, TowerWidgets.enabledWidgets()){
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
            ...
            if(viewHolder == null){
                viewHolder = ViewHolder(view.findViewById<ImageView>(R.id.widget_pref_icon),
                        view.findViewById<CheckBox>(R.id.widget_check),
                        view.findViewById<TextView>(R.id.widget_pref_title),
                        view.findViewById<TextView>(R.id.widget_pref_summary),
                        view.findViewById<View>(R.id.widget_pref_info))
            }
