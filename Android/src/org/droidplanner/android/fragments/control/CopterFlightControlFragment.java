            ...
            switch (action) {
                ...
                case AttributeEvent.FOLLOW_STOP:
                    ...
                    if (followState != null) {
                        ...
                        if (eventLabel != null) {
                            GAUtils.logEvent(GAUtils.Category.FLIGHT, ACTION_FLIGHT_ACTION_BUTTON, eventLabel);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.mc_land:
                ...
                eventLabel = VehicleMode.COPTER_LAND.getLabel();
                break;
            ...
            case R.id.mc_homeBtn:
                ...
                eventLabel = VehicleMode.COPTER_RTL.getLabel();
                break;
            ...
            case R.id.mc_autoBtn:
                ...
                eventLabel = VehicleMode.COPTER_AUTO.getLabel();
                break;
