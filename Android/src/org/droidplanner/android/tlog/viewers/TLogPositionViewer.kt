...
class TLogPositionViewer : TLogViewer(), TLogEventListener {
    ...
    private val eventsView by lazy {
        getView()?.findViewById<RecyclerView>(R.id.event_list)
    }

    private val fastScroller by lazy {
        getView()?.findViewById<FastScroller>(R.id.fast_scroller)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        tlogPositionAdapter = TLogPositionEventAdapter(requireContext(), eventsView!!)
        ...
        val goToMyLocation = view.findViewById<FloatingActionButton>(R.id.my_location_button)
