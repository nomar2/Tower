...
class TLogDataPicker : DialogFragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?){
        ...
        val tlogsView = view.findViewById<RecyclerView>(R.id.tlogs_selector)
        ...
        val adapter = TLogDataAdapter(requireActivity().getApplication() as DroidPlannerApp, childFragmentManager, currentSessionId)
