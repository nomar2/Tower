...
class DownloadMapboxMapActivity : AppCompatActivity() {
    ...
    private val downloadMapWarning: View by lazy {
        findViewById<View>(R.id.download_map_warning)
    }

    private val downloadMapContainer: View by lazy {
        findViewById<View>(R.id.download_map_container)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        downloadProgressBar = findViewById<ProgressBar>(R.id.map_download_progress_bar)

        val goToMyLocation = findViewById<View>(R.id.my_location_button)
        ...
        val goToDroneLocation = findViewById<View>(R.id.drone_location_button)
